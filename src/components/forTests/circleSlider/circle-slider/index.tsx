...
export class CircleSlider extends React.Component<IProps, IState> {
    ...
    public handleMouseUp = (event: Event): void => {
        ...
        const currentStep = this.circleSliderHelper.getCurrentStep();
        this.props.onFinish(currentStep);
    ...
    public render() {
        ...
        let opinions = ['=(','Schlimm', 'OK', 'Zufrieden', '(=']
        let tooltipColors = ['#FF471A', '#F6961E', '#ECDB23', '#AEE228', '#6AD72D']
        let {currentStepValue} = this.state;
        let current = opinions[currentStepValue];
        tooltipColor = tooltipColors[currentStepValue];
